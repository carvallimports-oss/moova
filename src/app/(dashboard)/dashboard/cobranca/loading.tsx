  ...
  return (
    <div className="p-6 lg:p-8 pt-20 lg:pt-8 max-w-2xl mx-auto space-y-8">
      <div className="space-y-1.5">
        ...
        <div className="h-4 w-40 bg-[#D4C5A0] rounded animate-pulse" />
      </div>
      <div className="h-20 bg-[#D4C5A0] rounded-xl animate-pulse" />
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="h-48 bg-[#D4C5A0] rounded-xl animate-pulse" />
        <div className="h-48 bg-[#D4C5A0] rounded-xl animate-pulse" />
      </div>
      <div className="h-24 bg-[#D4C5A0] rounded-xl animate-pulse" />
    </div>
  )
}
