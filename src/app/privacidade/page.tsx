    ...
    <div className="min-h-screen bg-[#FAF7F2] px-4 py-16">
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="font-serif text-3xl text-[#2D4A3E]">Política de Privacidade</h1>
          <p className="text-[#8A8A8A] text-sm">Última atualização: maio de 2026 · LGPD compliant</p>
        </div>

        <div className="prose prose-sm max-w-none text-[#3A3A3A] space-y-6">
          <section className="space-y-3">
            <h2 className="font-serif text-lg text-[#2D4A3E]">1. Controlador dos Dados</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg text-[#2D4A3E]">4. Base Legal</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg text-[#2D4A3E]">5. Compartilhamento com Terceiros</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg text-[#2D4A3E]">6. Retenção de Dados</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg text-[#2D4A3E]">8. Segurança</h2>
